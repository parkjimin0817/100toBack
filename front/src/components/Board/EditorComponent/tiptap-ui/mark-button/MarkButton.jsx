...
// --- Icons ---
import { BoldIcon, ItalicIcon, StrikeIcon, SubscriptIcon, SuperscriptIcon, UnderlineIcon } from "../../tiptap-icons/icon";
...
export function shouldShowMarkButton({ editor, type, hideWhenUnavailable, markInSchema }) {
...
export const MarkButton = React.forwardRef(function MarkButton(
  {
