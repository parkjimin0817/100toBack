...
// --- Icons ---
import { AlignCenterIcon, AlignJustifyIcon, AlignLeftIcon, AlignRightIcon } from "../../tiptap-icons/icon"
...
export function useTextAlign(editor, align, disabled = false, hideWhenUnavailable = false) {
  ...
  const shouldShow = React.useMemo(() => {
    return shouldShowTextAlignButton(editor, canAlign, hideWhenUnavailable)
