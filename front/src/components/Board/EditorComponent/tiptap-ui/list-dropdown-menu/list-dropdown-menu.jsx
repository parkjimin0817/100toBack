...
// --- Icons ---
import { ChevronDownIcon, ListIcon } from "../../tiptap-icons/icon"
...
export function shouldShowListDropdown({ editor, listTypes, hideWhenUnavailable, listInSchema, canToggleAny }) {
  if (!listInSchema || !editor) return false
