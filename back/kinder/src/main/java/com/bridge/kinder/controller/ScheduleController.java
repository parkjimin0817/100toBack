...
public class ScheduleController {
    ...
    //스케줄 리스트 불러오기
    @GetMapping("/lists")
    public ResponseEntity<List<ScheduleDto.ScheduleResponse>> getSchedules(@RequestBody ScheduleDto.ScheduleResponse dto){
        List<ScheduleDto.ScheduleResponse> response = scheduleService.getSchedules(dto);
