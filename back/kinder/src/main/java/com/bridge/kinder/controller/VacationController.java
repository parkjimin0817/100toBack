...
public class VacationController {
    ...
    //휴가 신청
    @PostMapping("/request")
    public ResponseEntity<VacationDto.Response> requestVacation(@RequestBody VacationDto.Request request) {
        String memberId = jwtTokenProvider.getMemberIdFromToken();
        return ResponseEntity.ok(vacationService.requestVacation(memberId, request));
    }
