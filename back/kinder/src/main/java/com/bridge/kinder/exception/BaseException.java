package com.bridge.kinder.exception;
...
public abstract class BaseException extends RuntimeException {
    ...
    //예외 발생 시 구체적인 에러정보를 담는 enum타입 객체
    ...
    //특정 상황에 더 구체적인 설명을 하고싶을 때 errorcode의 값을 늘리지 않고 간단하게 처리 가능.
    ...
    //우리가 만든 예외(BaseExecption)로 실제 발생한 예외를 감싸서 다시 던지는 방식
